var e={};e=import.meta.resolve("3vR5K");var a={};a=import.meta.resolve("i1c9Y");var t={};t=import.meta.resolve("71fzH");var r={};r=import.meta.resolve("hfX9h");var s={};s=import.meta.resolve("b47zw");var i={};i=import.meta.resolve("aXxKx");var o={};o=import.meta.resolve("jkq1P");var n={};n=import.meta.resolve("azv73");var l={};l=import.meta.resolve("6J8wm");var m={};m=import.meta.resolve("ihSYM");var c={};c=import.meta.resolve("jqPUY");var f={};f=import.meta.resolve("cMnMb");var p={};p=import.meta.resolve("36ava");var d={};d=import.meta.resolve("1GdxK");class h extends HTMLElement{connectedCallback(){let h=new URL(e).href,v=new URL(a).href,g=new URL(t).href,b=new URL(r).href,u=new URL(s).href,y=new URL(i).href,x=new URL(o).href,w=new URL(n).href,k=new URL(l).href,L=new URL(m).href,Y=new URL(c).href,$=new URL(f).href,R=new URL(p).href,U=new URL(d).href,z=Array.from("Happy Birthday, Sauru").map((e,a)=>`<span class="char" style="--i:${a}">${" "===e?"&nbsp;":e}</span>`).join("");this.innerHTML=`
            <style>
            ...
            <div class="hero">
                ...
                <div class="frames">
                    <div class="frames-top">
                        ...
                        <div class="frame"><img src="${g}"  alt=""></div>
                    ...
                    <div class="frames-right">
                        ...
                        <div class="frame"><img src="${k}"  alt=""></div>
                    </div>
                    ...
                    <div class="frames-bottom">
                        ...
                        <div class="frame"><img src="${R}" alt=""></div>
                        <div class="frame"><img src="${U}" alt=""></div>
                    </div>
                </div>
                ...
                <div class="hero-inner">
                    ...
                    <h1 class="title">${z}<span class="spark">\u{1F496}</span></h1>
        ...
        `;let M=this.querySelector(".cta"),F=this.querySelector(".hero");if(M&&F){let e=this.querySelector(".confetti");e||((e=document.createElement("div")).className="confetti",F.appendChild(e)),M.addEventListener("click",()=>{M.classList.add("active"),((a=16)=>{let t=["🎉","✨","🎊","💖","🌸"];for(let r=0;r<a;r++){let a=document.createElement("span");a.className="confetti-item",a.textContent=t[Math.floor(Math.random()*t.length)];let r=8+84*Math.random();a.style.left=r+"%",a.style.fontSize=`${10+22*Math.random()}px`,a.style.animationDelay=`${220*Math.random()}ms`,a.style.transform=`translateX(${(Math.random()-.5)*40}px)`,e.appendChild(a),setTimeout(()=>a.remove(),2200)}})(18),setTimeout(()=>{M.classList.remove("active"),window.location.href="/src/celebration.html"},1200)})}}}customElements.define("my-hero",h),document.addEventListener("DOMContentLoaded",()=>{if(!document.querySelector("my-hero")){let e=document.createElement("my-hero");document.body.prepend(e)}});
//# sourceMappingURL=birthday-site.f0837449.js.map
